...
| `TAILSCALE_IP` | *auto-discovered* | — | Pi `.env` | `install.sh` finds it by querying the tailnet for the `runpod-vllm` peer |
...
| `docker-compose.yml` | Blueprint for the two Pi containers | Commented inline |
